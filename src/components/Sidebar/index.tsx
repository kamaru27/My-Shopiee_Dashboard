        ...
        icon: (
          ...
          >
            ...
            <path
              ...
              strokeMiterlimit={10}
              strokeWidth={1.5}
              d="m9.68 6.38 1.04-4.32M16.38 6.39l.94-4.34"
            />
            <path
              stroke="#292D32"
              strokeLinecap="round"
        ...
        icon: (
          ...
          >
            <path
              // fill="#030D45"
              fill="currentColor"
              d="M9.04 2.505c-.816-.202-1.836-.404-2.652-.404-.817 0-1.837.202-2.653.404-.715.101-1.225.707-1.327 1.414C2.306 4.727 2 6.343 2 7.455c0 1.11.204 2.525.306 3.535.102.707.612 1.313 1.327 1.414.714.202 1.836.303 2.653.303.816 0 1.836-.202 2.653-.303.714-.101 1.224-.707 1.326-1.414.204-1.01.306-2.424.306-3.535 0-1.112-.204-2.728-.306-3.536a1.42 1.42 0 0 0-1.224-1.414ZM20.265 11.596c-.714-.202-1.836-.303-2.653-.303-.816 0-1.836.202-2.653.303-.714.1-1.224.707-1.326 1.414-.204 1.01-.306 2.424-.306 3.535 0 1.111.204 2.526.306 3.536.102.707.612 1.313 1.326 1.414.715.202 1.837.303 2.653.303.817 0 1.837-.202 2.653-.303.715-.101 1.225-.707 1.327-1.414.204-1.01.306-2.425.306-3.536 0-1.11-.102-2.525-.306-3.535-.102-.707-.612-1.313-1.327-1.414ZM9.143 15.636c-.816-.202-1.837-.303-2.755-.303-.919 0-1.939.202-2.755.303-.613.101-1.123.606-1.327 1.212-.204.707-.306 1.314-.306 1.819 0 .505.102 1.01.306 1.818.204.606.714 1.01 1.327 1.212.816.202 1.836.303 2.755.303.918 0 1.939-.202 2.755-.303.612-.101 1.122-.606 1.326-1.212.205-.707.306-1.313.306-1.819 0-.505-.101-1.01-.306-1.818-.204-.707-.714-1.11-1.326-1.212ZM14.857 8.364c.817.202 1.837.303 2.755.303.919 0 1.939-.202 2.755-.303.613-.101 1.123-.607 1.327-1.213.204-.707.306-1.313.306-1.818 0-.505-.102-1.01-.306-1.818-.204-.606-.714-1.01-1.327-1.212C19.551 2.1 18.531 2 17.612 2c-.918 0-1.938.202-2.755.303-.612.101-1.122.606-1.326 1.212-.205.707-.306 1.313-.306 1.818 0 .505.101 1.01.306 1.818.204.707.714 1.112 1.326 1.213Z"
            />
          </svg>
        ),
        label: "Categories",
          ...
          >
            ...
            >
              <path
                // fill="#0d0d0d"
                fill="currentColor"
                d="M882.7 305.3c11.6 14.7 15.7 33.5 11.3 51.6l-43.4 179.9c-8.1 33.5-37.8 56.9-72.3 56.9H454.2v-20.1h324.1c25.1 0 46.8-17.1 52.8-41.5l43.4-179.9c2.9-12.1.2-24.7-7.5-34.5s-19.3-15.4-31.8-15.4H336.4v-20.1h498.9c18.5 0 35.8 8.4 47.4 23.1z"
              />
              <path
                // fill="#0d0d0d"
                fill="currentColor"
                d="M800.5 701.8v20.1H415.1c-28.3 0-53.1-19.1-60.4-46.5L233 215.7c-4.9-18.6-21.8-31.5-40.9-31.5h-84.2v-20.1H192c28.3 0 53.1 19.1 60.4 46.5l121.8 459.7c4.9 18.5 21.8 31.5 41 31.5h385.3zm-50.3 55.3c38.1 0 69.1 31 69.1 69.1 0 38.1-31 69.1-69.1 69.1s-69.1-31-69.1-69.1c0-38.1 31-69.1 69.1-69.1zm49 69.1c0-27-22-49-49-49s-49 22-49 49 22 49 49 49 49-22 49-49z"
              />
              <path
                fill="#050505"
                d="M765.5 199.4V248c0 10.6-8.6 19.1-19.2 19.1h-1.6v15h-8.9v-15h-93.7v15h-10.4v-91c-.9 0-1.7.1-2.5.1-7.1 0-14.6-.2-22.5-.7h-2.2c-3.1.2-6.1.3-9.1.4v91.2H585v-15h-96.3v15h-8.9v-15h-4.2c-10.6 0-19.2-8.6-19.2-19.1v-48.7c0-10.6 8.6-19.1 19.2-19.1h42.8c-7.4-3.9-13-8.7-16.3-14.6-10.3-18.2 3-37.9 3.6-38.7 9.6-11.6 20.3-16.7 32.3-15.3 30.3 3.4 58.3 48.9 67.6 65.5 9.3-16.6 37.3-62.1 67.6-65.5 11.9-1.3 22.7 3.7 32 14.9.9 1.2 14.1 21 3.9 39.1-3.3 5.9-8.9 10.7-16.3 14.6h53.6c10.6 0 19.1 8.6 19.1 19.2zM755.2 248v-48.7c0-4.8-3.9-8.8-8.8-8.8h-98.3c-1.9.1-3.9.3-5.9.4v65.9h104.2c4.8 0 8.8-3.9 8.8-8.8zM700 160.5c7.1-12.5-3-27.7-3.1-27.8-6.7-8.1-14.3-11.8-22.5-10.8-22.4 2.5-47 37.9-58.6 58.3h33.4c33.1-2.5 46.1-11.4 50.8-19.7zm-138.2 19.7h33.7c-11.6-20.4-36.2-55.8-58.6-58.3-8.3-.9-15.8 2.7-22.8 11.2 0 0-9.8 15-2.8 27.4 4.7 8.2 17.6 17.2 50.5 19.7zm23.3 76.6v-65.6h-3c-6.8 0-13-.3-18.9-.7h-87.5c-4.8 0-8.8 3.9-8.8 8.8V248c0 4.8 3.9 8.8 8.8 8.8h109.4z"
              />
              <path
                fill="#FFF0C2"
                d="M755.2 199.4V248c0 4.8-3.9 8.8-8.8 8.8H642.2V191c2-.1 4-.2 5.9-.4h98.3c4.8 0 8.8 3.9 8.8 8.8z"
              />
              <path fill="#FFE085" d="M642.2 267.2h93.7v15h-93.7z" />
              <path
                fill="#F59A9B"
                d="M696.9 132.7c.1.2 10.2 15.3 3.1 27.8-4.7 8.2-17.7 17.2-50.8 19.7h-33.4c11.6-20.4 36.2-55.8 58.6-58.3 8.3-1 15.8 2.7 22.5 10.8zm-90.2 57.9c7.9.5 15.4.7 22.5.7.9 0 1.7-.1 2.5-.1v91h-36.4V191c3-.1 6-.2 9.1-.4h2.3zm-11.2-10.4h-33.7c-32.9-2.5-45.9-11.5-50.5-19.7-7.1-12.4 2.8-27.4 2.8-27.4 7-8.5 14.5-12.1 22.8-11.2 22.4 2.5 47 37.9 58.6 58.3z"
              />
              <path fill="#FFE085" d="M488.8 267.2h96.3v15h-96.3z" />
              <path
                fill="#FFF0C2"
                d="M585.1 191.2v65.6H475.7c-4.8 0-8.8-3.9-8.8-8.8v-48.7c0-4.8 3.9-8.8 8.8-8.8h87.5c5.9.4 12.1.7 18.9.7.9.1 2 0 3 0z"
              />
              <path
                // fill="#0d0d0d"
                fill="currentColor"
                d="M435.7 757.1c38.1 0 69.1 31 69.1 69.1 0 38.1-31 69.1-69.1 69.1s-69.1-31-69.1-69.1c0-38.1 31-69.1 69.1-69.1zm49 69.1c0-27-22-49-49-49s-49 22-49 49 22 49 49 49 49-22 49-49z"
              />
            </g>
            <path
              // fill="#0d0d0d"
      ...
      },
      {
        icon: (
          <svg
            ...
            viewBox="0 0 297 297"
          >
            <path d="M201.578 207.587c0 6.683 5.397 12.168 12.08 12.168h71.241c3.905 0 7.572-1.953 9.844-5.131a12.165 12.165 0 0 0 1.606-10.985l-9.738-28.52 9.714-27.842a12.102 12.102 0 0 0-11.426-16.089h-10.468a2767.644 2767.644 0 0 0-5.068 16.089l-.033.105c-3.453 11.035-7.023 22.446-10.597 32.884a27.104 27.104 0 0 1-25.639 18.326c-2.989 0-5.944-.493-8.778-1.465a235.709 235.709 0 0 0-22.739-6.507v16.967z" />
            <path d="M233.096 183.591c5.03 0 9.727-3.161 11.448-8.185 3.52-10.281 7.07-21.631 10.505-32.608 3.385-10.822 6.886-22.014 10.299-31.988a12.101 12.101 0 0 0-7.527-15.369 336.798 336.798 0 0 0-109.32-18.196A336.814 336.814 0 0 0 39.182 95.441a12.1 12.1 0 0 0-7.528 15.369c3.413 9.974 6.915 21.166 10.3 31.988 3.434 10.978 6.984 22.327 10.504 32.608 1.72 5.025 6.419 8.185 11.447 8.185 1.301 0 2.622-.211 3.921-.656a248.537 248.537 0 0 1 80.676-13.427c27.508 0 54.651 4.518 80.676 13.427 1.296.444 2.618.656 3.918.656z" />
            <path d="M94.512 190.857c-7.307 1.739-14.681 3.822-21.826 6.268a27.031 27.031 0 0 1-8.782 1.466 27.098 27.098 0 0 1-25.638-18.326c-3.584-10.468-7.164-21.913-10.641-33.028a2734.486 2734.486 0 0 0-5.057-16.05H12.101A12.104 12.104 0 0 0 .675 147.276l9.713 27.843L.65 203.604c-1.264 3.696-.665 7.843 1.606 11.02 2.272 3.178 5.938 5.131 9.845 5.131H82.41c6.683 0 12.101-5.486 12.101-12.168v-16.73z" />
          </svg>
        ),
        label: "Banners",
        route: "/admin/banners",
