...
const ProductTable = ({ listOfProducts }: Props) => {
  ...
  return (
    <>
      <div className="rounded-[10px] border border-stroke bg-white py-4 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:py-7.5">
       {productData.length>0 ?<><div className="flex justify-between ml-7">
          <div>
                ...
                <tr key={index}>
                  ...
                  >
                    <div className="flex items-center justify-end space-x-3.5">
                      <Link href={`/admin/products/view/${packageItem._id}`}>
                      ...
                      <Link href={`/admin/products/edit/${packageItem._id}`}>
